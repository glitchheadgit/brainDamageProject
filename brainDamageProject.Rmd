...
data$Возраст <- scale(data$Возраст, center = TRUE, scale = FALSE)
data$SOFA_1d <- scale(data$SOFA_1d, center = TRUE, scale = FALSE)
data$Индекс_коморбидности_Чарлсона_1d <- scale(data$Индекс_коморбидности_Чарлсона_1d, center = TRUE, scale = FALSE)
data$CGS_балл <- scale(data$CGS_балл, center = TRUE, scale = FALSE)
data$oneday_log <- scale(data$oneday_log, center = TRUE, scale = FALSE)
data$`8ohdg 1d log` <- scale(data$`8ohdg 1d log`, center = TRUE, scale = FALSE)
